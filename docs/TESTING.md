...
from custom_components.ectocontrol_modbus import config_flow, const
...
from custom_components.ectocontrol_modbus.const import REGISTER_CH_TEMP
...
from custom_components.ectocontrol_modbus import const
...
async def test_full_integration_setup(hass: HomeAssistant, monkeypatch):
    ...
    monkeypatch.setattr(
        "custom_components.ectocontrol_modbus.ModbusProtocol",
        FakeProtocolOK
    )
